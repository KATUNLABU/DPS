...
export const MACHINES: Machine[] = [
  // ═══════════════════════════════════════════════════
  // SECCIÓN 1: EQUIPOS INKJET (IMPRESORAS)
  // ═══════════════════════════════════════════════════
  {
    ...
    features: [
      ...
      "Diseño compacto para laboratorio o línea de etiquetado",
  ...
  },
  {
    ...
    description: "Impresora industrial de alta producción para etiquetas en bobina con tintas pigmentadas en base agua. Diseñada para tirajes cortos y medianos con secado NIR (Near InfraRed) instantáneo.",
    ...
    features: [
      ...
      "Apta para etiquetas de alimentos, bebidas y productos químicos",
  ...
  },
  {
    ...
    industries: ["Etiquetas Industriales", "Señalamiento", "Bebidas y Vinos", "Etiquetas Pyme"]
  },
  {
    id: "katun-klt3",
    name: "Katun KLT3 Industrial",
    subtitle: "Prensa Digital Inkjet para Etiquetas en Bobina",
    category: "impresoras",
    technology: "Inkjet Piezoeléctrico UV / Agua",
    speed: "Hasta 30 m/min",
    resolution: "1200 x 1200 dpi",
    maxWidth: "33 cm (13\")",
    description: "Impresora industrial robusta diseñada para operar 24/7 en entornos exigentes de conversión de etiquetas autoadhesivas.",
    ...
    industries: ["Etiquetas Químicas", "Cosmética", "Decoración", "Vinos y Licores"]
  },
  {
    ...
    description: "El sistema todo-en-uno definitivo para etiquetas: imprime digitalmente en alta resolución, lamina en frío, troquela y retira la matriz de desperdicio en una sola pasada.",
    badge: "HÍBRIDA PRO",
    ...
    industries: ["Vinos y Licores", "Farmacéutica", "Químicos GHS", "Etiquetas Premium"]
  },
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    resolution: "±0.05 mm",
    maxWidth: "35 cm (13.7\")",
    description: "Serie versátil de plotters de corte de etiquetas disponibles en anchos de 250mm y 350mm con sujeción por vacío.",
    badge: "VACUUM PLATEN",
    ...
    features: [
      "Platen de succión por vacío multi-zona para sujeción perfecta del sustrato de etiqueta",
      "Cabezales de corte trabajando en paralelo",
  ...
  },
  {
    ...
    category: "cortadoras",
    technology: "Plotter de Cuchilla Drag Knife",
    speed: "6 m/min",
    resolution: "±0.1 mm",
    maxWidth: "24 cm (9.4\")",
  ...
  },
  {
    ...
    subtitle: "Plotter Digital de Acabado de Etiquetas y Semicorte",
    category: "cortadoras",
    technology: "Cuchilla Tangencial Digital (1 Cuchilla)",
    speed: "Cerca de 1 m/min",
    resolution: "±0.05 mm",
    maxWidth: "30 cm (11.8\")",
    description: "Plotter compacto de corte digital equipado con 1 cuchilla tangencial de alta precisión, alineación por sensor óptico y rebobinado de matriz para etiquetado.",
    badge: "1 CUCHILLA TANGENCIAL",
    image: "/imagenes/cortadora-kf30x-brochure-web-pdf-791x1024.jpg",
    pdfUrl: "/maquinas/cortadora-kf30x-brochure-web.pdf",
    features: [
      "Sistema de 1 cuchilla tangencial digital de gran precisión",
      "Velocidad de trabajo cercana a 1 m/min para máxima definición en bordes",
      "Laminador en frío con control de tensión de freno",
      "Estructura pesada antivibraciones"
    ],
    specs: [
      { label: "ANCHO TRABAJO", value: "300 mm" },
      { label: "CABEZALES", value: "1 cuchilla tangencial digital" },
      { label: "VELOCIDAD REAL", value: "Cerca de 1 m/min" }
    ],
    industries: ["Etiquetas Adhesivas", "Rotulación", "Pequeñas Series de Etiquetas"]
  },
  {
    id: "arrow-ezcut-330rx",
    name: "Arrow EZCut 330RX",
    subtitle: "Sistema Digital de Acabado y Corte de Etiquetas",
    category: "cortadoras",
    technology: "Cuchillas Neumáticas Digitales",
    speed: "Hasta 18 m/min",
    resolution: "Precisión 0.05 mm",
    maxWidth: "33 cm (13\")",
    description: "Estación de acabado digital compacta que integra laminación, corte de contorno continuo con cuchillas neumáticas, refilado de bordes y doble rebobinado.",
    ...
    features: [
      ...
      "Cabezales de corte con ajuste neumático de presión",
      "Laminado en frío incorporado",
      "Extracción automática de sobrante de etiqueta"
    ],
    specs: [
      { label: "ANCHO BANDA", value: "330 mm" },
      { label: "SISTEMA CORTE", value: "Cuchillas de corte continuo" }
    ],
  ...
  },
  {
    ...
    maxWidth: "35 cm (13.7\")",
    description: "Manejo avanzado de bobina con troquelado semi-rotativo servomotorizado. Permite utilizar cilindros de troquel magnético universales para acabados impecables en etiquetas.",
    badge: "SEMI-ROTATIVA",
    ...
    industries: ["Convertidores de Etiquetas", "Imprentas Comerciales", "Etiquetas Industriales"]
  },
  {
    id: "arrow-ezcut-350r",
    name: "Arrow EZCut 350R Láser",
    subtitle: "Sistema de Troquelado y Acabado Láser de Etiquetas",
    category: "cortadoras",
    technology: "Láser CO2 Galvanométrico",
    speed: "Hasta 50 m/min",
    resolution: "Submicrónica (Haz Láser)",
    maxWidth: "35 cm (13.7\")",
    description: "Troquelado digital mediante haz de luz láser CO2 de alta precisión. Elimina totalmente el uso de troqueles físicos o cuchillas mecánicas, permitiendo cambios de diseño instantáneos.",
    badge: "CORTE LÁSER",
    ...
    features: [
      "Fuente láser CO2 galvanométrica de respuesta ultra-rápida (corte 100% óptico)",
      "Corte de formas complejas, microperforaciones y semicorte de etiqueta",
      "Cambio automático de trabajo por lectura de código QR",
      "Sin desgaste mecánico de componentes de corte"
    ],
    specs: [
      { label: "TECNOLOGÍA LÁSER", value: "Láser CO2 de alta frecuencia (Sin cuchillas)" },
  ...
  },
  {
    ...
    subtitle: "Cortadora Digital de Etiquetas en Hojas y Pliegos",
    category: "cortadoras",
    technology: "Corte Digital por Hoja/Pliego",
    speed: "Hasta 12 m/min",
    resolution: "Cámara CCD Óptica",
    maxWidth: "35 cm x 50 cm",
    description: "Equipo versátil para cortar etiquetas impresas en pliegos y hojas digitales. Ideal para cortar contornos de etiquetas adhesivas en papel y sintéticos.",
    badge: "CORTE EN HOJA",
    ...
    features: [
      "Alimentación automática de pliegos de etiquetas",
    ...
    industries: ["Imprentas Digitales Sheetfed", "Diseño y Prototipado", "Etiquetas en Pliego"]
  },
  {
    id: "lc-350-pm",
    name: "Cortadora LC 350 PM Katun DPS",
    subtitle: "Sistema de Troquelado Láser Industrial para Etiquetas",
    category: "cortadoras",
    technology: "Láser CO2 Galvanométrico Industrial",
    speed: "Hasta 80 m/min",
    resolution: "Submicrónica (Óptica Haz Láser)",
    maxWidth: "35 cm (13.7\")",
    description: "El sistema insignia de troquelado óptico por láser de Katun DPS. Diseñado para líneas de conversión industrial de etiquetas de alto rendimiento. Proceso 100% láser sin cuchillas mecánicas.",
    ...
    features: [
      "Velocidad extrema de troquelado láser de hasta 80 m/min",
      "Corte por haz óptico de luz CO2 (sin desgaste ni uso de cuchillas mecánicas)",
      "Lectura QR al vuelo para cambio de diseño en microsegundos",
      "Módulo de barnizado UV e inspección de calidad opcional"
    ],
    specs: [
      { label: "SISTEMA DE CORTE", value: "Corte Láser Óptico CO2 (Sin Cuchillas)" },
      { label: "TECNOLOGÍA LÁSER", value: "CO2 RF sellado galvanométrico" },
      { label: "VELOCIDAD MÁXIMA", value: "80 m/min" }
    ],
    industries: ["Converter Industrial de Etiquetas", "Farmacéutica de Alto Volumen", "Bebidas Globales"]
  },

  // ═══════════════════════════════════════════════════
  // SECCIÓN 3: CONTADOR DE ETIQUETAS AUTOMÁTICO
  // ═══════════════════════════════════════════════════
  {
